...
int main() {
    ...
    //Test 4) assignment operator (this is actually initialisation)
    polynomial p2 = p;
    cout << p2 << endl;
    ...
    //ptest2 does not exist yet, so the = sign here does not mean assignment 
    //this is the same as polynomial ptest2(ptest)
    ...
    // labeled_point lp2(2, 4, "mypoint");

    // cout << lp2 << endl;    

    // cout << "Is lp < lp2 ?: " << (lp < lp2) << endl;
    // cout << "Is lp == lp2 ?: " << (lp == lp2) << endl;
}